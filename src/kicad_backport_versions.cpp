...
const std::map<std::string, VERSION_MAP>& targetVersions()
{
    ...
    static const std::map<std::string, VERSION_MAP> targets = {
        ...
        { "6.0",  { { KIND::SYMBOL_LIBRARY, "20211014" }, { KIND::SCHEMATIC, "20211123" }, { KIND::BOARD, "20211014" }, { KIND::FOOTPRINT, "20211014" }, { KIND::WORKSHEET, "20210606" }, { KIND::DESIGN_RULES, "1" } } },
        { "7.0",  { { KIND::SYMBOL_LIBRARY, "20220914" }, { KIND::SCHEMATIC, "20230121" }, { KIND::BOARD, "20221018" }, { KIND::FOOTPRINT, "20221018" }, { KIND::WORKSHEET, "20220228" }, { KIND::DESIGN_RULES, "1" } } },
        { "8.0",  { { KIND::SYMBOL_LIBRARY, "20231120" }, { KIND::SCHEMATIC, "20231120" }, { KIND::BOARD, "20240108" }, { KIND::FOOTPRINT, "20240108" }, { KIND::WORKSHEET, "20231118" }, { KIND::DESIGN_RULES, "1" } } },
        { "9.0",  { { KIND::SYMBOL_LIBRARY, "20241209" }, { KIND::SCHEMATIC, "20250114" }, { KIND::BOARD, "20241229" }, { KIND::FOOTPRINT, "20241229" }, { KIND::WORKSHEET, "20231118" }, { KIND::DESIGN_RULES, "1" } } },
        { "10.0", { { KIND::SYMBOL_LIBRARY, "20251024" }, { KIND::SCHEMATIC, "20260306" }, { KIND::BOARD, "20260206" }, { KIND::FOOTPRINT, "20260206" }, { KIND::WORKSHEET, "20231118" }, { KIND::DESIGN_RULES, "1" } } },
        { "10.99", { { KIND::SYMBOL_LIBRARY, "20260629" }, { KIND::SCHEMATIC, "20260722" }, { KIND::BOARD, "20260728" }, { KIND::FOOTPRINT, "20260728" }, { KIND::WORKSHEET, "20231118" }, { KIND::DESIGN_RULES, "1" } } },
    };
